      ...
      <main className="flex flex-col gap-section-gap px-container-margin py-stack-lg pb-40">
        <header className="relative z-10 flex flex-col gap-stack-sm">
          <div className="mb-2 flex w-fit items-center gap-2 rounded-full border border-outline-variant/30 bg-surface-container-high px-3 py-1">
            ...
            <span className="font-label-caps text-label-caps text-on-surface-variant">Step 3 of 3</span>
          </div>
          <h2 className="font-display-lg text-display-lg tracking-tight text-on-surface">Accept Terms & Submit</h2>
          <p className="font-body-sm text-body-sm leading-relaxed text-on-surface-variant">
            Please review and accept the required terms before unlocking immersive features.
          </p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between gap-3 px-1">
              <div className="flex items-center gap-2 font-chinese-sub text-chinese-sub text-on-surface-variant">
                ...
                <span>
                  Signed on: <span className="font-medium text-on-surface">{new Date().toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
                </span>
              </div>
              <div className="text-right text-[10px] uppercase tracking-widest text-outline-variant">Encrypted Key Generated</div>
            </div>
          </div>
        </section>
      </main>
